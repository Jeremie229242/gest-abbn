...
@section('title','GEST-APP | Modification  Roles')
@section("contenu")
    ...
    <div class="min-height-200px">
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>Modifier le rôle : {{ $role->name }}</h4>
							</div>
						...
						<div class="col-md-6 col-sm-12 text-right">
							<div class="dropdown">
								<a class="btn btn-primary dropdown-toggle" href="{{ route('Admin.roles.index') }}" >
									Liste des roles
								</a>
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						...
						<p class="mb-30">Modifier des roles qui seront affecter a chaque utilisateur</p>
					</div>
        ...
        @method('PUT')
            ...
            <input type="text" name="slug" id="slug" value="{{ $role->slug }}" class="form-control" required>
        </div>
									</div>
								</div>
