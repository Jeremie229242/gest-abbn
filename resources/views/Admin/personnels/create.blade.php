...
@section('title','GEST-APP | Ajout de Personnels')
@section("contenu")
    ...
    <div class="min-height-200px">
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>Créer un nouvel Personnel</h4>
							</div>
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						...
						<p class="mb-30">Créer des personnels </p>
					</div>
            ...
            <input type="number" name="tel" id="telephone" class="form-control" required>
        </div>
									</div>
								</div>
